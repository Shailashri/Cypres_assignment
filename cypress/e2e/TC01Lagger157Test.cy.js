...
it.skip('TC06 - Adding items to the cart with register user', ()=>{
    ...
    //cy.get('.CMS-Dropdown-icon').click();
    cy.get('.CMS-Dropdown-icon').click();
    cy.get('[data-id="16847533806341204"] > .CMS-Component > .CMS-AttributeName-container > .CMS-AttributeName-attributes > :nth-child(7) > .CMS-AttributeName > .CMS-AttributeName-attribute').click();
